...
var Engine = (function(global) {
    ...
    // 添加控制游戏开始与暂停的dom元素
    var operDom = doc.createElement('div');
    operDom.className = "operate";
    ...
    function main() {
         ...
         * 来调用这个函数
         */
        global.reqAF =  win.requestAnimationFrame(main);
    }
    ...
    function stop() {
        if (global.reqAF) {
            window.cancelAnimationFrame(global.reqAF);
            global.reqAF = undefined;
        }
    }
